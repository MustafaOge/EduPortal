...
namespace EduPortal.Persistence.Migrations
{
    ...
    [Migration("20240315091943_InvoiceRelationComplete3")]
    partial class InvoiceRelationComplete3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduPortal.Domain.Entities.SubsCorporate", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("SubsCorporate");
                });
            ...
            modelBuilder.Entity("EduPortal.Domain.Entities.SubsIndividual", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("SubsIndividual");
                });
